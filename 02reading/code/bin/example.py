...
class Main:
    ...
    def __init__(self):
        # 02reading/code/src/Main.hx:14
        print("Python reading and writing Example")
        # 02reading/code/src/Main.hx:17
        _hx_str = ("Hello World!\tWritten on: " + HxOverrides.stringOrNull(Date.now().toString()))
        # 02reading/code/src/Main.hx:20
        f = sys_io_File.write("hello.txt",False)
        # 02reading/code/src/Main.hx:21
        f.writeString(_hx_str)
        # 02reading/code/src/Main.hx:22
        f.close()
        # 02reading/code/src/Main.hx:25
