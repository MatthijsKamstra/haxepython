...
class Main:
    ...
    def __init__(self):
        ...
        if (json is None):
            ...
            # src/Main.hx:17
            json = _hx_AnonObject({'update': Date.now(), 'created': _created, 'counter': _counter})
        # src/Main.hx:19
...
class Sys:
    ...
    @staticmethod
    def args():
        # /usr/local/lib/haxe/std/python/_std/Sys.hx:58
    ...
    def systemName():
        ...
        # /usr/local/lib/haxe/std/python/_std/Sys.hx:93
        x = _g
        # /usr/local/lib/haxe/std/python/_std/Sys.hx:92
        if StringTools.startsWith(x,"linux"):
            ...
            _g1 = _g
            _hx_local_0 = len(_g1)
            # /usr/local/lib/haxe/std/python/_std/Sys.hx:96
            if (_hx_local_0 == 5):
                if (_g1 == "win32"):
                    return "Windows"
                else:
    ...
    def getChar(echo):
        ...
        if (_hx_local_0 == 5):
            if (_g1 == "Linux"):
                ...
                # /usr/local/lib/haxe/std/python/_std/Sys.hx:145
                x1 = _g
                # /usr/local/lib/haxe/std/python/_std/Sys.hx:146
...
class haxe_format_JsonPrinter:
    ...
    def write(self,k,v):
        ...
        if (_g1 == 0):
            ...
            # /usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:87
            _this = self.buf
            s = Std.string(v)
            _this.b.write(s)
        elif (_g1 == 2):
            ...
            # /usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:134
            _this2 = self.buf
            s2 = Std.string(v)
            _this2.b.write(s2)
        elif (_g1 == 4):
    ...
    def quote(self,s):
        ...
        while True:
            ...
            if (c == -1):
                break
            # /usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:205
            c1 = c
            ...
            if (c1 == 8):
                ...
                # /usr/local/lib/haxe/std/haxe/format/JsonPrinter.hx:217
                _this1 = self.buf
                s2 = "".join(map(chr,[c]))
                _this1.b.write(s2)
...
class haxe_io_Input:
    ...
    def set_bigEndian(self,b):
        # /usr/local/lib/haxe/std/haxe/io/Input.hx:96
        self.bigEndian = b
        # /usr/local/lib/haxe/std/haxe/io/Input.hx:97
        return b
...
class python_Lib:
    ...
    @staticmethod
    def println(v):
        # /usr/local/lib/haxe/std/python/Lib.hx:50
        _hx_str = Std.string(v)
...
class sys_io_File:
    ...
    def write(path,binary = True):
        ...
        if (binary is None):
            binary = True
        # /usr/local/lib/haxe/std/python/_std/sys/io/File.hx:67
...
class utils_Read:
    ...
    def json(folderName,fileName):
        ...
        # src/utils/Read.hx:9
        _filePath = (((("null" if _path is None else _path) + "") + ("null" if fileName is None else fileName)) + ".json")
        # src/utils/Read.hx:13
        json = None
        # src/utils/Read.hx:14
        if sys_FileSystem.exists(_filePath):
            json = python_lib_Json.loads(sys_io_File.getContent(_filePath),**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
        else:
            json = None
        ...
        if (not sys_FileSystem.exists(_path)):
            try:
                ...
                if isinstance(_hx_e1, str):
                    ...
                    raise _hx_e
        # src/utils/Write.hx:27
        _fileName = (("null" if fileName is None else fileName) + ".json")
        # src/utils/Write.hx:28
        _filePath = ((("null" if _path is None else _path) + "") + ("null" if _fileName is None else _fileName))
