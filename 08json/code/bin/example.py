...
class Main:
    ...
    def __init__(self):
        ...
        if sys_FileSystem.exists(path):
            # src/Main.hx:17
            _hx_str = sys_io_File.getContent(path)
            # src/Main.hx:18
            self.json = python_lib_Json.loads(_hx_str,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
            # src/Main.hx:20
            self.createList()
        else:
    ...
    def createList(self):
        ...
        html = ""
        # src/Main.hx:29
        html = (("null" if html is None else html) + "id\tname\tusername\temail\tphone\twebsite\n")
        # src/Main.hx:30
        # src/Main.hx:30
        _g1 = 0
...
class HxString:
    ...
    @staticmethod
    def get_length(s):
        # /usr/local/lib/haxe/std/python/internal/StringImpl.hx:85
        return len(s)
