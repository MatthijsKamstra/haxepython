...
class Main:
    ...
    def createList(self):
        ...
        html = ""
        # src/Main.hx:68
        html = (("null" if html is None else html) + "<table style=\"width:100%\">")
        # src/Main.hx:69
        html = (("null" if html is None else html) + "<tr><th>id</th><th>name</th><th>birthday</th><th>phoneNumber</th></tr>")
        # src/Main.hx:70
        # src/Main.hx:70
        _g1 = 0
